...
\begin{itemize}
  ...
  \item the impact of compressive architecture by performing a comparative study of a full cnn architecture versus two autoencoder ones.\fg{a reformuler}
\end{itemize}
...
Further increasing the dilation factor to $D=3$ is not beneficial, as the receptive field is sufficiently large with $D=2$ (values not shown due to space constraints). Following this, a compact but effective architecture is selected with $D=2$, $K=17$, $L=6$, and $C=64$.
