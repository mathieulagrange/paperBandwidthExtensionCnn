...
\end{tabular}
\caption{Srr achieved by the different methods on the \textit{medely-solosdb} dataset using the \textit{mirror} and \textit{oracle} phase estimates.}
\label{tab:srrSolos}
\end{table}
